...
//            System.out.println("else " + worldObj.getBlockMetadata(xCoord, yCoord, zCoord) + " " + toDestroy);
    ...
    public int[][][] getRendArrays()
    {
        ...
        for (int x = 0; x < size; x++)
        {
            ...
            {
                n[x + 1][z + 1] = pattern[x][z];
                rtn[0][x][z] = pattern[x][z];
            }
        }
